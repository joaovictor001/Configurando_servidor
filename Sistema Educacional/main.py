...
class MyMandler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path =='/Turmas':
            ...
            try:
                with open(os.path.join(os.getcwd(), 'Cadastro de Turma.html'), 'r') as login_file:
            ...
            with open(os.path.join(os.getcwd(), 'Cadastro de Turma.html'), 'r', encoding='utf-8') as login_file:
                content = login_file.read()
            ...
            with open(os.path.join(os.getcwd(), '   .html'),'r', encoding='utf-8') as novo_cadastro_file:
